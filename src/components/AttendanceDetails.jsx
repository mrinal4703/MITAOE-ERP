...
function AttendanceDetailsContainer() {const overall = {
    totalClasses: 12,
    totalPresent: 9,
    totalAbsent: 3,
    totalOD: 0,
  ...
  return (
    <div className="bg-white p-4 rounded-xl mb-6">
      ...
      {/* Table Header */}
      <div className="grid grid-cols-[1.2fr_2fr_1.2fr_1fr_1fr_1fr_1fr_1.2fr] text-xs font-semibold text-gray-700 border-b mb-2">
      ...
      <div className="divide-y divide-gray-200">
        {attendanceData.map((item, idx) => (
          ...
          >
            <div className="text-blue-600 underline">{item.courseCode}</div>
